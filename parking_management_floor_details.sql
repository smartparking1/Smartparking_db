...
CREATE TABLE `floor_details` (
  ...
  CONSTRAINT `building_id` FOREIGN KEY (`building_id`) REFERENCES `building_details` (`building_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `floor_details` VALUES (1,'1-SBR MINAR',40,'active',1),(2,'1-SBR HORIZON',50,'active',4),(3,'1-Sbr ok',40,'active',9),(4,'2-Sbr ok',50,'active',9);
